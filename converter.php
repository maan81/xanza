...
<html>
  <head>
    <title>Amount Currency to Currency - Symbol to Symbol Currency Converter</title> <!-- Add amount converted (default 1), From and to currency name, symbol from and to -->
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="daily-stats">
                <h1 class="number primary" style="font-size:220%"><!-- Show default for page as 1 unit of base currency. For all other conversion queries populate with convert amount -->
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <select class="form-control">
                <option value="">From Currency</option><!-- Populate with base currency as default -->
              </select>
              <br>
              <select class="form-control">
                <option value="">To Currency</option><!-- Populate with conversion currency as default -->
              </select>
              <br>
      ...
      <div class="row">
          ...
          <div class="panel panel-default">
            <div class="panel-heading clearfix">
             <i class="icon-jpy"></i><i class="icon-usd" style="margin-left:5px;margin-right:5px;"></i><i class="icon-eur"></i><i class="icon-gbp" style="margin-left:5px;margin-right:5px;"></i>
              <h3 class="panel-title">Convert Amount Currency Name in Other Currency</h3> <!-- Replace "amount" with page amount, replace "currency name" with base currency to others -->
            </div>
            ...
            <div class="panel-body">
              ...
              <div id="myTabContent" class="tab-content">
                ...
                <table class="table no-margin">
                  ...
                  <tbody><!-- Replace "amount" with page amount (default 1), replace base "currency name" with page base name -->
                      <tr>
        ...
        <div class="col-md-6 col-sm-6 col-xs-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
             <p>Include text here from a file named profile-symbol.php , "symbol" changing to base currency name for this paragraph</p><!-- example include profile-euro.php -->
			 <p>Include text here from a file named profile-symbol.php , "symbol" changing to target currency name for this paragraph</p><!-- example include profile-usd.php -->
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-8 col-sm-12 col-sx-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table -bordered no-margin"><!-- Populate with latest base currency conversions to any other currency -->
                  <tbody>
                    <tr>
        ...
        <div class="col-md-4 col-sm-12 col-sx-12">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              <div class="table-responsive">
                <table class="table table -bordered no-margin"><!-- Populate with most queried base currency conversions -->
                  <tbody>
                    <tr>
                      <td><a href="">100 EUR to GBP</a></td>
                      <td><a href="">45 USD to GBP</a></td> 
